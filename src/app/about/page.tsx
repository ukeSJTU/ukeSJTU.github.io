  ...
  return (
    ...
    >
      ...
      <div className="mt-6 flex max-w-2xl flex-col gap-4 font-serif text-lg leading-[1.8]">
        <p>
          I'm {siteConfig.author.name}. This is a growing collection of notes on
          what I'm learning and building. I'll share more about myself and this
          site as it takes shape.
        </p>
        <p>
